...
local Controller = 		require(global.FRAMEWORK_PUREMVC_PATH .. "core.Controller")
local Model = 			require(global.FRAMEWORK_PUREMVC_PATH .. "core.Model")
local View = 			require(global.FRAMEWORK_PUREMVC_PATH .. "core.View")
local Notification = 	require(global.FRAMEWORK_PUREMVC_PATH .. "patterns.observer.Notification")
